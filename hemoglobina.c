...
void main(){
    ...
    if (edad>=0&&edad<=1&&hemoglobina>=13&&hemoglobina<=26)
        ...
        printf ("No tiene anemia");
    else if (edad>=12&&edad<=60&&hemoglobina>=11.5&&hemoglobina<=15)
        printf ("No tiene anemia");
    else if (edad>=60&&edad<=120&&hemoglobina>=12.6&&hemoglobina<=15.5)
        printf ("No tiene anemia");
    else if (edad>=120&&edad<=180&&hemoglobina>=13&&hemoglobina<=15.5)
        printf ("No tiene anemia");
    else
        printf ("Tiene anemia");
}
